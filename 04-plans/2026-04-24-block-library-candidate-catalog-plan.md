...
**Tech Stack:** Markdown docs trong `VPS/docs/superpowers/flatsome-native`, existing factory docs, templates và reports.
...
**Files:**
- Create: `VPS/docs/superpowers/flatsome-native/04-plans/2026-04-24-block-library-candidate-catalog-plan.md`
...
**Files:**
- Create: `VPS/docs/superpowers/flatsome-native/03-factory/Block Library Candidates.md`
...
- Modify: `VPS/docs/superpowers/flatsome-native/03-factory/Page Goal Routing.md`
...
**Files:**
- Create: `VPS/docs/superpowers/flatsome-native/07-reports/Block Library Candidate Catalog Report.md`
...
- [ ] Chạy:
  - `rg -n "Block Library Candidates|Mức ưu tiên|Trạng thái sẵn sàng|kiểm catalog block" VPS/docs/superpowers/flatsome-native`
- [ ] Kỳ vọng:
