...
**Tech Stack:** Markdown docs trong `./`, `data/flatsome-studio/exports (ngoài hub)`, official docs `docs.uxthemes.com`.
...
**Files:**
- Create: `04-plans/2026-04-24-official-surface-syntax-capture-plan.md`
...
**Files:**
- Modify: `07-reports/Official Demo Surface Ingestion Report.md`
- Create: `07-reports/Official Surface Syntax Capture Report.md`
...
- [ ] Chạy:
  - `rg -n "syntax capture pending|tabgroup|team_member|ux_portfolio|\\[map |\\[lightbox |\\[logo |\\[video_button" ./`
- [ ] Kỳ vọng:
