# Design Intelligence Layer Report

Date: 2026-04-24

## Mục Tiêu

Tạo thêm một lớp `UI Intelligence` để đi cùng `Flatsome Native Core`.
...
- `08-design-intelligence/Style Taxonomy.md`
- `08-design-intelligence/Pattern Decision Matrix.md`
...
- `08-design-intelligence/templates/MASTER Design System Template.md`
- `08-design-intelligence/templates/Page Override Template.md`
...
- `Flatsome Core` cho mode mặc định
- `Design Intelligence` cho mode đề xuất / sáng tạo

nhưng quyền quyết định cuối về khả năng build vẫn nằm ở `Flatsome Native`.
