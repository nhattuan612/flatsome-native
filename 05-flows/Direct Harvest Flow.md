...
- state: `data/ (ngoài hub) flatsome-studio/harvest-state.json`
- catalog line-by-line: `data/ (ngoài hub) flatsome-studio/catalog.ndjson`
- raw export từng template: `data/flatsome-studio/exports (ngoài hub)/<templateId>.json`
